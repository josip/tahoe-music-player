...
function start() {
  BrowserCouch.get(
    ...
    function(db) {
      ...
      function run() {
        statusArea.textContent = "Started " + (window.startTime = new Date());
        db.view(
          {map: function(doc, emit) {
           ...
           finished: function(aResult) {
             statusArea.textContent = "Finished " + ((new Date()) - window.startTime);
           }}
        );
      }
    },
